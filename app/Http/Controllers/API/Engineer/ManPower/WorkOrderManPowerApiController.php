...
namespace App\Http\Controllers\API\Engineer\ManPower;
...
class WorkOrderManPowerApiController extends Controller
{
    /**
     * GET Work Orders for Man Power Projects by PN Number
     */
    ...
    /**
     * CREATE new Work Order for Man Power Projects
     */
    ...
    /**
     * UPDATE Work Order for Man Power Projects
     */
    ...
    public function getWoSummary()
    {
        ...
        $projects = Project::query()
            ...
            ->with(['quotation.client', 'statusProject', 'client']) // load relasi
